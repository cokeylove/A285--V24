...
//-----------------------------------------------------------------
#define PortC_Init    0x01              // PORT Data
...
#define PortD5_Ctrl   OUTPUT             // 33  //DOCK_USB2_BUS_EN# A485D00032+ BPWRG //PD_VBUS_C_CTRL1_EC
...
#define PortE4_Ctrl   INPUT             // 125  LAN_WAKE#
#define PortE5_Ctrl   OUTPUT            // 35   CP_RESET#
#define PortE6_Ctrl   INPUT            // 17   EC_TX
#define PortE7_Ctrl   ALT             // 20		_EC_SMB_DA4
...
#define PortI4_Ctrl   ALT               // 70   _ADC4 for FAN_ID
...
//-----------------------------------------------------------------
#define PortL_Init		0x80            // PORT Data  
...
#define EC_ON2_HI()       		//SET_MASK(GPDRL,BIT(0)) ////A485D00002 Delete for EE change
#define EC_ON2_LOW()      		//CLEAR_MASK(GPDRL,BIT(0)) //A485D00002 Delete for EE change
...
#define Read_VDDPALWPWRGD()  	IS_MASK_SET(GPDRE,BIT(1))
...
#define Read_LAN_WAKE_IN()  	IS_MASK_CLEAR(GPDRE,BIT(4))
...
#if Support_TWO_BATT
#define M1_DRV_LOW()       	CLEAR_MASK(GPDRC,BIT(3))
#define M1_DRV_HI()         	SET_MASK(GPDRC,BIT(3))
