...
#define KBC_ENABLE_PS2_CONTROL      (TRUE)  //A285D00073
...
#define ENABLE_64G_KEY_WORK_RUN         (TRUE)  //A285D00060+
...
#define FAN_CTRL_CPUFAIL_ALERT      (1) //A285D00057:
//-----------------------------------------------------------------------------
// Keyboard scan
//-----------------------------------------------------------------------------
...
#define SUPPORT_FIRST_BOOTUP_EC_CONFIG     (1)
...
#define Support_SMTADP        FALSE   // Support Smart Adaptor  //A285D00017: Fix wake on lan fail//A485D00057: Fix wake on lan Fail
...
#define	Support_VGA_FANTABLE	FALSE
#define Support_IFC				FALSE //A285D00022: Disable support IFC for thermal change
#define	IFC_TEMP				44
#define STP_THOT_ON				77
#define STP_THOT_OFF			75
#define	STP_SHDN				99
#define VEN1_STP_FAN_RPM		36	// AVC
#define VEN1_STP_FAN_DUTY		60

#define VEN2_STP_FAN_RPM		35	// AVC
#define VEN2_STP_FAN_DUTY		60

#define VEN3_STP_FAN_RPM		36	// Delta
#define VEN3_STP_FAN_DUTY		60

#define STP_FAN_RPM				36
#define STP_FAN_DUTY			60
...
#define Only_One_BATT		  TRUE  //A285D00009: Change to support single battery
...
#define Trickle_Control_By_CHGIC  TRUE  // FALSE:control by EE, TRUE: control by charge IC // False -->Ture A285D00002: Fixed battery unlock ship mode fail.
#define Trickle_ChargeCurr     0x0100     // 256mA
#define Trickle_ChargeVolt     0x2E0E     // 12V
#define Tricklechargecurrent   100        // 100mA  //A485D000104:
...
#define TypeC_Addr       TPS65988_A_I2C_ADDR    // Type-C CCG3 I2C address  //A485D00038:
...
#define SMB_AUTO_Channel {SmBat_Addr    , chSMB_BAT},\
                         {SecSmBat_Addr , chSMB_2ndBAT},\
	                       ...
	                       {DGPU_Addr     , chSMB_VGA},\
	                       {TypeC_01_Addr     , chSMB_TYPEC},\
	                       {TypeC_02_Addr     , chSMB_TYPEC},\
