...
//A285D00049: fix usb3.0 identify abnormal
#if SUPPORT_FIRST_BOOTUP_EC_CONFIG
#define FirstBootupStatus                                   SD_uchar_8(OEMRAM2+0x26)
#define FristBootACOnCount                              SD_uchar_8(OEMRAM2+0x27)
#define FirstBootACOffCount                              SD_uchar_8(OEMRAM2+0x28)
#endif
...
#define   pKBLED_off_Count							SD_uchar_8(OEMRAM2+0x5E) 
...
//A285D00051: new fan table spec implementation--start
//cpu temperature calculate  5s per time - 20180402
#define TEMP_Buff_4									SD_uchar_8(OEMRAM3 + 0x52) //A485D00092
#define TEMP_Buff_5									SD_uchar_8(OEMRAM3 + 0x53)

//thermal sensor read 3s per time - 20180402
#define   FANTSSeg									SD_uchar_8(OEMRAM3 + 0x5A)
#define TEMP_TS_1									SD_uchar_8(OEMRAM3 + 0x5B)
#define TEMP_TS_2									SD_uchar_8(OEMRAM3 + 0x5C)
//A285D00051: new fan table spec implementation--end
...
#define   Ext_CPU_Shut_Cnt							SD_uchar_8(OEMRAM3+0x96) //A485D00039
...
*/
//A485D00039
#define   FANEXTSeg							SD_uchar_8(OEMRAM3+0xD2)
...
//A485D00039: Modify Fan table for meet the A485_FAN_Control_Table_PWM_FVT_V00_2017-1226.
#define	thermalTBlMode						SD_uchar_8(OEMRAM3+0xE5)
	#define	PFM_Mode				1	// performance mode
	#define COOL_Mode				2	// cool mode
#define	ThermalTBlMode_M						SD_uchar_8(OEMRAM3+0xE6) //A485D00091
...
#define  ENHANCED_PC_BEEP_RAM6    SD_uint_16(OEMRAM4+0xE4)  //A485D00053: Add beep delay time over 60S
...
#define  RAM_DETECT_PLUG_OUT_TIMES			SD_uchar_8(OEMRAM4+0xE6)
#define  RAM_PLUG_STATUS					SD_uchar_8(OEMRAM4+0xE7)
// add for Enhanced Beep alarm when MEM lost -  //A485D00087:
...
#define afterFlashMark								SD_uchar_8(OEMRAM9+0x65) //A485D00044: Fix Update BIOS&EC FW EC hang up.
#define HWAUthSMBusFailCnt							SD_uchar_8(OEMRAM9+0x66)  //A485D00076
#define BATTBATLOWSHDProt							SD_uchar_8(OEMRAM9+0x67)  //A485D00077


#define AVGcurrent                                  SD_ulong_32(OEMRAM9+0x70)
#define AVGvolatage                                 SD_ulong_32(OEMRAM9+0x74)


#define RSMRSTDelayCnt                              SD_uchar_8(OEMRAM9+0x81)
#define BATOCPCnt                                   SD_uchar_8(OEMRAM9+0x82) //A485D00078
#define ReadAdaIDFailCnt                            SD_uchar_8(OEMRAM9+0x83) //A485D00080

#define  TYPE_C_RAM33             SD_uchar_8(OEMRAM9+0x91)
#define  TYPE_C_RAM34              SD_uchar_8(OEMRAM9+0x92)
#define  TYPE_C_RAM35              SD_Ptr_uchar_8(OEMRAM9+0x93)//for type-c used 0x93~0x94
...
#define  TYPE_C_RAM43		SD_uchar_8(OEMRAM9+0xA2)
#define  TYPE_C_RAM44		SD_uint_16(OEMRAM9+0xA4)
#define  TYPE_C_RAM45		SD_uint_16(OEMRAM9+0xA6)
#define  TYPE_C_RAM46		SD_uchar_8(OEMRAM9+0xA8)
#define  TYPE_C_RAM47		SD_uchar_8(OEMRAM9+0xA9)

#if ENABLE_64G_KEY_WORK_RUN //A285D00060
#define USB_Delay                   SD_uchar_8(OEMRAM9+0xB0)
#endif

#define  PD4ccCMD_WaitCnt                                       SD_uchar_8(OEMRAM9+0xBA)
//-------------------------------------------------------------------------
...
#define   Chk_Buf_Half_Full_En                  BIT0        //A285D00067+
...
#define   PriBattSTS								SD_uchar_8(OEMRAMA+0x38)
 ...
 #define  ChargingGet       		IS_MASK_SET(PriBattSTS,Charging)
...
#define   SecBattSTS								SD_uchar_8(OEMRAMA+0x39)
 #define  SecChargingEn        		SET_MASK(SecBattSTS,Charging)
 #define  SecChargingDis       		CLEAR_MASK(SecBattSTS,Charging)
 #define  SecChargingGet       		IS_MASK_SET(SecBattSTS,Charging)
...
#define   u4SenseSTS3								SD_uchar_8(OEMRAMA+0x49)
 ...
 //A285D00048: Add unsupport adapter process,set flag for bios
...
//A285D00076 start+
#define  uShipModeWorkRun                                           SD_uchar_8(OEMRAMA+0xD4)
#define  BAT1_SHIPMODE_ENABLE                                BIT0
#define  BAT2_SHIPMODE_ENABLE                                BIT1
#define  BAT1_SHIPMODE_SUCCESS                               BIT4
#define  BAT2_SHIPMODE_SUCCESS                               BIT5
//A285D00076 end+
...
#define    Usb_Pdc_Power_Status2					(*((USB_POWER_STATUS *)(OEMRAMC+0x32)))
#define    Usb_Pdc_Status2							(*((USB_STATUS *)(OEMRAMC+0x33)))
#define    UCSI_RDO1								SD_uchar_8(OEMRAMC+0x34)
#define    UCSI_RDO2								SD_uchar_8(OEMRAMC+0x35)
#define    UCSI_RDO3								SD_uchar_8(OEMRAMC+0x36)
#define    UCSI_RDO4								SD_uchar_8(OEMRAMC+0x37)
#define    UCSI_CONNECTOR_STATE						SD_uchar_8(OEMRAMC+0x38)
#define    UCSI_POWER_SOURCE						SD_uchar_8(OEMRAMC+0x39)
#define    UCSI_POWER_SOURCE2						SD_uchar_8(OEMRAMC+0x3A)
#define    UCSI_POWER_DATA_SOURCE_REJECT			SD_uchar_8(OEMRAMC+0x3B)
#define    UCSI_POWER_ROLE_SWAP_COMPLETE			SD_uchar_8(OEMRAMC+0x3C)
#define    WorkaroundforBIOSSMI                     SD_uchar_8(OEMRAMC+0x3D) //A485D00069
#define    WorkaroundforBIOSSMIcunt                 SD_uchar_8(OEMRAMC+0x3F) //A485D00069
...
#define    UCSI_CONNECTOR_NUMBER_CHANGED    	    SD_Ptr_uchar_8(OEMRAMC+0xAC)  //0xAC~0xAD
#define    UCSI_NOTIFICATION_ENABLE    	            SD_uint_16(OEMRAMC+0xAE)  //0xAE~0xAF
#define    UCSI_CONNECTOR_CHANGE_STATUS    	        SD_Ptr_uint_16(OEMRAMC+0xB0)  //0xB0~0xB3
#define    UCSI_OPTIONAL_FEATURE    	            SD_uchar_8(OEMRAMC+0xB4)
#define    UCSI_DEVICE_CONNECTED    	            SD_Ptr_uchar_8(OEMRAMC+0xB5)  //0xB5~0xB6
